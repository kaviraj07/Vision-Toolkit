...
if __name__ == "__main__":
    ...
    rotation_degree = st.number_input("Enter the degree of rotation:", min_value=-360, max_value=360, value=45)
    ...
    if uploaded_file is not None:
        ...
        with button_col1:
            if st.button('Rotate Image'):
                ...
                theta_1_rad = transform_func.icv_deg_to_radians(rotation_degree)
                ...
                rotated_image_placeholder.image(st.session_state['rotated_image'], caption='Rotated Image', use_column_width=True)
        ...
        with button_col2:
            if st.session_state['rotated_image'] is not None:
                image_transformed_pil = Image.fromarray(st.session_state['rotated_image'])
